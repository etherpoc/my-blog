...
const OrderSwitch = ({orderState, setOrderState}:OrderSwitchProps) => {
    ...
    <div className={styles.order_switch_container}>
        ...
        <div className={styles.swiches}>
            <div className={`${styles.select_block} ${orderState=="id" ? styles.left: orderState=="title" ? styles.center:styles.right}`}/>
            <div className={orderState=="id"   ? styles.selected_order_value:styles.order_value } onClick={()=>{setOrderState("id")}}>  id</div>
